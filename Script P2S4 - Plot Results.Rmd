...
```{r}
pdf(file=file.path("Plots","histograms_variables_combined.pdf"),height=40, width=15)
par(mfrow=c(30,5), mar=c(1,1,3,1))
for (i in c(envvar, outcomes)){
    hist(df0_imputed_BothGroups[,i], main=i, col="grey")
  }
dev.off()
